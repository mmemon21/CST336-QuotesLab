...
app.get('/', function(req, res){
  var smth = 'select country from l9_author';
    connection.query(smth, function(error, results) {
...
app.get('/author', function(req, res){
    var smth = 'select * from l9_author where firstName=\'' 
                + req.query.firstname + '\' and lastName=\'' 
                + req.query.lastname + '\';'
	connection.query(smth, function(error, found){
	    var author = null;
	    if(error) throw error;
	    if(found.length){
	        author = found[0];
